...
Curso: SICI 4038
Dr. Miguel Vélez
Propósito: Esta página tiene como propósito descargar los archivos en materiales de clases.
*/
...
if (isset($_GET['id'])) {
    $id    = $_GET['id'];
    $query = "SELECT name, type, size, content FROM files_manual WHERE id = $id";
