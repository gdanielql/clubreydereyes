...
<div style="position:relative; height:60px;">
  <img src="images/register.png" class="img-rounded" style="position:absolute; top:-100px; right:450px; width:200px; height:200px; border:none;" alt="Register" title="Register" />
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-12 col-lg-12">
      <h1 class="page-header">Registra un miembro</h1>
...
<a class="btn btn-primary btn-block" href="index.php?page=memberinfo">Atrás</a>
</div>
